...
const CardLink = ({ label , url , setIsClickNext , setIsMinimum , errors , index  })=>{
    const onClick = ()=>{
...
const CardEdit = ({ index , register , remove , errors , setCurrentLabel , setIsMinimum , categories: categories1 , setCategories , setCurrentUrl , label  })=>{
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)(react_.Box, {
        marginTop: "1rem",
...
const CardEditWrapper = ({ label , index , remove , register , errors , setCategories , categories , setIsClickNext , isClickNext , isLast  })=>{
